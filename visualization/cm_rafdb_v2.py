...
from sgu24project.models.resnet_v2 import resnet50, resnet50_vggface2, resnet50_vggface2_ft
...
if args.model_name == 'resnet50_cbam_duck_pytorchcv':
    ...
    model = resnet50_vggface2_ft(pretrained = False, use_cbam = True if args.use_cbam == 1 else False, use_duck = True if args.use_duck == 1 else False)
