...
class SeparatedConv2DBlock_upgrate(nn.Module):
    def __init__(self, in_channels, out_channels, size=3):
        ...
        self.conv1 = nn.Conv2d(in_channels, planes, kernel_size=(1, size), padding=(0, size//2))
...
class WidescopeConv2DBlock_upgrate(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(WidescopeConv2DBlock_upgrate, self).__init__()
        planes = int(in_channels/4)
        self.conv1_dw = nn.Conv2d(in_channels, planes, kernel_size=3, padding=1, groups=in_channels)
        ...
        self.conv2_dw = nn.Conv2d(in_channels, planes, kernel_size=3, padding=2, dilation=2, groups=out_channels)
        ...
        self.conv3_dw = nn.Conv2d(in_channels, planes, kernel_size=3, padding=3, dilation=3, groups=out_channels)
