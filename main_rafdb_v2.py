...
from models.resnet_v2 import resnet50, resnet50_vggface2, resnet50_vggface2_ft
...
if args.model_name == 'resnet50_cbam_duck_pytorchcv':
    ...
    model = resnet50_vggface2_ft(pretrained = False, use_cbam = False, use_duck = False, load_weight_path = args.load_weight_path)
