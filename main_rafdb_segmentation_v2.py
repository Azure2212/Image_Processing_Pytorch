...
parser.add_argument('--num-classes', default= 3, type=int, help='num-classes')
...
model = Resnet50UnetMultitask(in_channels=3, num_seg_classes=OUT_CLASSES, num_cls_classes=7, **kwargs)
